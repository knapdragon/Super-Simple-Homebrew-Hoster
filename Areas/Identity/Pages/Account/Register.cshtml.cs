...
namespace Super_Simple_Homebrew_Hoster.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<HomebrewUser> _signInManager;
        ...
        public RegisterModel(
            UserManager<HomebrewUser> userManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    user.BrewsCreated = [];    // Initialise BrewsCreated to empty list rather than null
        ...
        private HomebrewUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<HomebrewUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(HomebrewUser)}'. " +
                    $"Ensure that '{nameof(HomebrewUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<HomebrewUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<HomebrewUser>)_userStore;
        }
    }
}
